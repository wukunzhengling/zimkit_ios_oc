...
s.subspec 'ZIMKitCommon' do |common|
    common.source_files = 'ZIMKit/ZIMKitCommon/**/*.{h,m}'
end

s.subspec 'ZIMKitConversation' do |conversation|
  conversation.source_files = 'ZIMKit/ZIMKitConversation/**/*.{h,m}'
end

s.subspec 'ZIMKitGroup' do |group|
  group.source_files = 'ZIMKit/ZIMKitGroup/**/*.{h,m}'
end

s.subspec 'ZIMKitMessages' do |message|
  message.source_files = 'ZIMKit/ZIMKitMessages/**/*.{h,m}'
end
